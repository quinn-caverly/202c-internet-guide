...
export default function Rustacean() {
  return (
    <svg
      className="Rust-logo"
      clip-rule="evenodd"
    ...
    >
      ...
      />
      <path
        d="m727.738 435.211c0 18.541-10.93 33.572-24.408 33.572-13.477 0-24.406-15.031-24.406-33.572s10.929-33.574 24.406-33.574c13.478 0 24.408 15.033 24.408 33.574"
        fill="#fff"
        fill-rule="nonzero"
      />
      <path
      ...
      />
      <path
        d="m.367.129c-.731-.57-.144-.84-.144-.84.036.32.249.547.249.547.049-.384.053-.606.053-.606.678.514.064.931.064.931.038.104.183.211.317.29l.094.319c-.624-.367-.633-.641-.633-.641z"
        fill="url(#prefix___Linear2)"
        fill-rule="nonzero"
        transform="matrix(0 -239.021 -239.021 0 402.27 775.15)"
      />
    </svg>
  );
}
